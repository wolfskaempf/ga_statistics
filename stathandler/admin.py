...
class CommitteeStatisticAdmin(admin.ModelAdmin):
    # This defines what the Committee Model should look like in the Django Admin
    list_display = ["proposingCommittee", "speakingCommittee", "pointType", "pointResume"]
    search_fields = ["proposingCommittee", "speakingCommittee", "pointType", "pointResume"]
...
admin.site.register(CommitteeStatistic, CommitteeStatisticAdmin)
